...
int main(void)
{
	...
	shaders.push_back(std::make_pair<std::string, GLenum>("5-plane-texture.vert", GL_VERTEX_SHADER));
	shaders.push_back(std::make_pair<std::string, GLenum>("5-plane-texture.frag", GL_FRAGMENT_SHADER)); 
